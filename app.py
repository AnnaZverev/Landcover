...
def get_region_info(region_name):
    ...
    regions = {
        "Ростовская область (Цимлянское вдхр.)": {
            ...
            "bbox": [42.43, 47.68, 42.83, 47.98] # Широкий обзор
        },
        "Волгоградская область (Цимлянское вдхр.)": { # <-- НОВАЯ ТОЧКА
        ...
        "Свердловская область (река Ивдель)": {
            "center": [60.69, 60.43],
            "bbox": [60.23, 60.23, 60.63, 60.63]
        "Москва (агломерация)": {
            "center": [55.75, 37.61],
